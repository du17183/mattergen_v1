...
def test_seed_contract_is_disjoint_from_prior_ranges() -> None:
    known = set(range(20000, 20256)) | set(range(32000, 32064)) | set(range(40000, 40256)) | set(range(41000, 41064))
    assert known.isdisjoint(compat.SEEDS)
