...
> **⚠️ 分支：`experiment/a0-e3g-leakage-diagnostic256`**<br>
> **角色：Q3 Gate 训练重叠泄漏诊断分支**<br>
> **状态：`DIAGNOSTIC_ONLY — NOT_VALID_AS_INDEPENDENT_VALIDATION`**

- 冻结代码/审计 commit：`01e9b2c30e5c58e05eaae908ba291c518b977d03`
- 当前结果：Training-overlap 20000–20063：harm 0/64；held-out 20064–20255：harm 31/192；Fisher p=6.87e-5。
- 论文用途：仅用于泄漏诊断；held-out 192 只作补充；Mixed 256 禁止作为独立正式结果。
