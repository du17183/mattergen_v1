...
**⚠️ `DIAGNOSTIC_ONLY — NOT_VALID_AS_INDEPENDENT_VALIDATION`**

- 状态：`LEAKAGE_INFLATION_DETECTED=True`。
- Training-overlap：20000–20063；held-out：20064–20255；Mixed：20000–20255。
- 冻结实验代码：`01e9b2c30e5c58e05eaae908ba291c518b977d03`。
- 主要结果：训练重叠 harm 0/64，held-out harm 31/192，Fisher p=6.87e-5。
- 允许用途：泄漏方法学诊断；held-out 192 仅作补充。
- 禁止用途：training-overlap 和 Mixed 256 不得冒充独立正式结果。
