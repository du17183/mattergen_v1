...
> **⚠️ 分支：`feature/a0-e3g-formal256`**<br>
> **角色：旧 A0 256-seed 批次的正式复用资格审计分支**<br>
> **状态：`SOURCE_DATA_INCOMPLETE — NO_EFFECT_ESTIMATE_PRODUCED`**

- 冻结代码/审计 commit：`c1df24a8e5d118dcc99d7fb65b34e7f53be28969`
- 当前结果：候选 seeds 20000–20255 中有 64 个与 Q3 Gate 训练重叠，因此旧批次不具正式复用资格，未产生组合效果估计。
- 论文用途：仅用于数据资格审计；不得写成方法 No-Go。
