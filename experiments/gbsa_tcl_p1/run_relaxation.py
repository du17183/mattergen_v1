"""Run frozen P1 MatterSim-5M relaxations on four H20 GPUs."""
...
def main() -> None:
    ...
    for gpu, method in zip(GPU_IDS, METHODS):
        ...
        command = [
            ...
            "--device", "cuda", "--fmax", "0.05",
            "--max-natoms-per-batch", "512", "--cuda-3x3-det-workaround",
        ]
        ...
        print(json.dumps({
            "event": "relaxation_started", "method": method,
    ...
    for method, process, stream, log_path in running:
        ...
        stream.close()
        print(json.dumps({
            "event": "relaxation_complete", "method": method,
