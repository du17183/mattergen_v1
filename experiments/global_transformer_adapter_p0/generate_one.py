"""Generate one frozen 1000-step MatterGen P0 sample."""
...
def main() -> None:
    ...
    if (args.method == "C0") != (args.adapter_checkpoint is None):
        raise ValueError("C0 takes no adapter; MLP/Transformer require their checkpoint")
    ...
    if args.adapter_checkpoint is not None:
        ...
        adapter = build_global_adapter(args.method)
