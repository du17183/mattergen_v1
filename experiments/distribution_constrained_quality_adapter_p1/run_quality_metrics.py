...
ROOT = PROJECT_ROOT / "experiments/distribution_constrained_quality_adapter_p1"
...
def main() -> None:
    memory_fd = os.memfd_create("quality_adapter_p1_alex_mp_reference", os.MFD_ALLOW_SEALING)
