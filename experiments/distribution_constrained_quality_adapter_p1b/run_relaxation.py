"""Run five P1b screen MatterSim relaxations in parallel on separate GPUs."""
...
ROOT = (
    PROJECT_ROOT
    / "experiments/distribution_constrained_quality_adapter_p1b/screen16"
)
POTENTIAL = (
    PROJECT_ROOT
    / "checkpoints/official/mattersim/mattersim-v1.0.0-5M.pth"
)
