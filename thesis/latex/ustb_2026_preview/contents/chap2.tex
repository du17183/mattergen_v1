...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={图2-1 晶体结构的晶胞、分数坐标与周期映射示意图}]{../../../thesis/chapter2/figures/fig2_1_crystal_representation.png}}
\bicaption{晶体结构的晶胞、分数坐标与周期映射示意图}{Schematic of Crystal Cells, Fractional Coordinates, and Periodic Mapping}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={图2-2 扩散模型前向加噪与反向生成示意图}]{../../../thesis/chapter2/figures/fig2_2_diffusion_process.png}}
\bicaption{扩散模型前向加噪与反向生成示意图}{Forward Noising and Reverse Generation in Diffusion Models}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={图2-3 条件与无条件得分构成 CFG 的示意图}]{../../../thesis/chapter2/figures/fig2_3_cfg.png}}
\bicaption{条件与无条件得分构成 CFG 的示意图}{Construction of CFG from Conditional and Unconditional Scores}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={图2-4 MatterGen 三字段条件生成总体流程}]{../../../thesis/chapter2/figures/fig2_4_mattergen_overview.png}}
\bicaption{MatterGen 三字段条件生成总体流程}{Overall Workflow of MatterGen Three-Field Conditional Generation}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={图2-5 神经势的结构---能量---原子力关系示意图}]{../../../thesis/chapter2/figures/fig2_5_mlip_energy_force.png}}
\bicaption{神经势的结构---能量---原子力关系示意图}{Relationship among Structure, Energy, and Atomic Forces in a Neural Potential}
\end{figure}
