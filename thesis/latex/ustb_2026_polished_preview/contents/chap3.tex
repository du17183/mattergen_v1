...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={图3-1 创新点1的证据演化：方框表示各阶段冻结结论，而非单调性能曲线}]{../../../thesis_release/innovation1/figures_polished/I1_F6_evidence_progression.pdf}}
\bicaption{创新点1的证据演化：方框表示各阶段冻结结论，而非单调性能曲线}{Evidence Evolution of Innovation 1: Boxes Denote Frozen Stage Conclusions Rather Than a Monotonic Performance Curve}\label{fig:3-1}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={图3-2 C1-128 中 C0、Fixed-K2、Linear-K2 与 Random-\allowbreak K2 的 Property MAE}]{../../../thesis_release/innovation1/figures_polished/I1_F1_c1_property_mae.pdf}}
\bicaption{C1-128 中 C0、Fixed-K2、Linear-K2 与 Random-\allowbreak K2 的 Property MAE}{Property MAE of C0, Fixed-K2, Linear-K2, and Random-\allowbreak K2 on C1-128}\label{fig:3-2}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={图3-3 Fixed-K2 与 C0 的逐样本属性误差}]{../../../thesis_release/innovation1/figures_polished/I1_F2_fixed_vs_c0_paired.pdf}}
\bicaption{Fixed-K2 与 C0 的逐样本属性误差}{Per-Sample Property Error of Fixed-K2 and C0}\label{fig:3-3}
\end{figure}

\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={图3-4 Fixed-K2 相对 C0 的 20 000 次配对自助法增益分布}]{../../../thesis_release/innovation1/figures_polished/I1_F3_fixed_gain_bootstrap.pdf}}
\bicaption{Fixed-K2 相对 C0 的 20 000 次配对自助法增益分布}{20,000 Paired-Bootstrap Gain Distribution of Fixed-K2 Relative to C0}\label{fig:3-4}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={图3-5 C1-128 的代理质量护栏结果}]{../../../thesis_release/innovation1/figures_polished/I1_F4_quality_guardrails.pdf}}
\bicaption{C1-128 的代理质量护栏结果}{Proxy Quality Guardrails on C1-128}\label{fig:3-5}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={图3-6 C0、Fixed-K2 及 Phase B 数据构建的计算量比较}]{../../../thesis_release/innovation1/figures_polished/I1_F5_compute_comparison.pdf}}
\bicaption{C0、Fixed-K2 及 Phase B 数据构建的计算量比较}{Computational Cost Comparison of C0, Fixed-K2, and Phase B Data Construction}\label{fig:3-6}
\end{figure}
