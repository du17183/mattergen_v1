Reproduction entry points: `python -m research.rp_qtfg.run_generation`, `python -m research.rp_qtfg.experiment_mag`, `python -m research.rp_qtfg.experiment_relax`, and `python -m research.rp_qtfg.analyze_experiment`. Server-specific run/resume/status/stop wrappers are archived under `scripts/`.
